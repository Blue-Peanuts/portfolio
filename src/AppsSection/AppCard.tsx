...
function GameCard(props: { name: string, img: string, lines: string[], animateOrder: number, link: string}) {
                    ...
                    <div className=' flex flex-row items-baseline justify-between'>
                        ...
                        <div>
                            <a href={props.link} target="_blank">
                                <button className='hover:bg-emerald-500 rounded-lg pl-2 pr-2 mt-2 font-bold
                             border-emerald-500 hover:text-slate-950 text-emerald-500  
                             sm:ml-0 hover:pl-4 hover:pr-4 transition-all'> Visit</button>
                            </a>
                        </div>
                    </div>
