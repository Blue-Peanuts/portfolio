    ...
    `}>
        ...
        <div className=' ml-0 w-[80vw] sm:w-64 sm:ml-6 flex flex-col justify-between items-center sm:items-start'>
            <span className=' text-white self-stretch'>
                ...
                <div>
                    <button className=' hover:bg-red-500 rounded-lg pl-2 pr-2 mt-2 font-bold border-4 border-red-500 hover:text-slate-950 text-red-500 ml-4 sm:ml-0'> Play on Itch.io </button>
                </div>
            </span>
        </div>
    </ScrollAnimation>
